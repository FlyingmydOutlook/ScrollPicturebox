...
using static SunUi.scrollPicturebox;
...
namespace SunUi
{
	...
	*
     *   开放API如下：
     *   Void  SetLabelLongPressHandler(Label label, LabelLongPressEventHandler handler)
            设置标签的长按事件处理程序。

          Void  SetLabelClickHandler(Label label, LabelClickEventHandler handler)
            设置标签的点击事件处理程序。
          ...
          Void  SetCrosshairColor(Color value)
            设置十字线的颜色，默认为红色，可设透明。

          Void  SetCrosshairLineWidth(float value)
            设置十字线的宽度，默认为1
    ...
    */
    ...
    public partial class scrollPicturebox : UserControl
    {
        ...
        private EventHandler e1 = null;
        private EventHandler e2 = null;
        private EventHandler e3 = null;
        private EventHandler e4 = null;
        //private LabelClickEventHandler handler = null;
        ...
        public scrollPicturebox()
        {
            ...
            clickTimer.Interval = 50; // 设置延迟时间为500毫秒
            ...
            label3.Location = new Point(panel1.Size.Width - panel1.Size.Width / 3 / 2, panel1.Size.Height / 2 - label3.Height / 2);
            label4.Location = new Point(panel1.Size.Width / 2 - label2.Width / 2, panel1.Size.Height - label3.Height);
            //this.Load += scrollPicturebox_Load;
       ...
       /* private void scrollPicturebox_Load(object sender, EventArgs e)
        ...
        private void panel1_Resize(object sender,EventArgs eventArgs)
        {
            ...
            UpdateLabelPosition(label3, panel1.Size.Width/2 + panel1.Size.Width / 3/1, scrollX, panel1.Size.Height / 2 - label3.Height / 2, scrollY);
            UpdateLabelPosition(label4, panel1.Size.Width / 2 - label2.Width / 2, scrollX, panel1.Size.Height - label3.Height * 3, scrollY);

            Debug.WriteLine("scrollpicbox:"+this.Size.Width);
            Debug.WriteLine("panel:"+panel1.Width);
            Debug.WriteLine("picbox:"+pictureBox1.Width);
        }
        ...
        private void RefreshTimer_Tick(object sender, EventArgs e)
        {
            if (images.Count > 0)
            {
                ...
                *//*pictureBox1.WaitOnLoad = false;
                pictureBox1.LoadAsync(images[imageIndex].ToString());*//*
        ...
        private void panel1_Scroll(object sender, ScrollEventArgs scrollEvent)
        {
            ...
            UpdateLabelPosition(label1, panel1.Size.Width / 2 - panel1.Size.Width / 3, scrollX, panel1.Size.Height / 2 - label1.Height / 2, scrollY);
            UpdateLabelPosition(label2, panel1.Size.Width / 2 - label1.Width/2, scrollX, label2.Height, scrollY);
            UpdateLabelPosition(label3, panel1.Size.Width - panel1.Size.Width/3/2, scrollX, panel1.Size.Height / 2 - label3.Height / 2, scrollY);
        ...
        public void SetLabelClickHandler(Label label, LabelClickEventHandler handler)
        {
            if (label==label1)
            {  
                e1 = new EventHandler(handler);
                label.Click += e1;
            }
            if (label == label2)
            {
                e2 = new EventHandler(handler);
                label.Click += e2;
            }
            if (label == label3)
            {
                e3 = new EventHandler(handler);
                label.Click += e3;
            }
            if (label == label4)
            {
                e4 = new EventHandler(handler);
                label.Click += e4;
            }

            Debug.WriteLine("sethandler"+e1);
        }
        ...
        public void LoadImage(Bitmap bitmap)
        {
            if (this.InvokeRequired)
            {
                this.Invoke(new Action<Bitmap>(LoadImage), bitmap);
                return;
            }
